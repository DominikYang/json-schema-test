...
public class ExamVO {
    ...
    public ExamVO withFoo(String foo) {
        this.foo = foo;
        return this;
    }
    ...
    public ExamVO withBar(Integer bar) {
        this.bar = bar;
        return this;
    }
    ...
    public ExamVO withBaz(Boolean baz) {
        this.baz = baz;
        return this;
    }
    ...
    public ExamVO withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ExamVO) == false) {
            return false;
        }
        ExamVO rhs = ((ExamVO) other);
